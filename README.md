...
This is a simple web application that converts grams to kilograms. The app is built using basic HTML and JavaScript and is served using an Apache web server within a Docker container. The Docker image is created from scratch then ubuntu Filesystem have been installed on top of it using debootstrap. 

## Table of Contents

- [Description](#description)
- [Process Followed](#process-followed)
- [Steps to Download and Run the Project](#steps-to-download-and-run-the-project)
